...
_This tutorial assumes that you already have your API key for the Gordian API and a fulfilled trip. For more information, see the [getting started guide](api-basics)._
