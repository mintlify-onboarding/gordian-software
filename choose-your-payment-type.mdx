...
description: "You can now decide the payment option that is right based on your use case. "
---
...
<Note>
    The White Label handles payment out of the box so there is no payment decision that needs to be made. See more information on [White Label payments](payment-settlements)
</Note>